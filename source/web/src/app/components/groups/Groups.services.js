(function () {
  ...
  function GroupService($log, $resource, URL_API) {
    ...
    var service = {
      ...
      add_user: $resource(URL_API + '/api/groups/:group_id/add/:user_id', {
        group_id: "@group_id",
        user_id: "@user_id"
      }, {'update': {method: 'PUT'}}),
      remove_user: $resource(URL_API + '/api/groups/:group_id/remove/:user_id', {
        group_id: "@group_id",
        user_id: "@user_id"
      }, {'update': {method: 'PUT'}}),
      delete_by_id: $resource(URL_API + '/api/groups/id/:id', {id: "@id"}),
      delete_by_name: $resource(URL_API + '/api/groups/name/:name', {name: "@name"})
